...
//
// Class Description: Implements a rolling die object.
...
public class RollingDie extends Die
{
  ...
  {
    // [CUSTOM] Creates a random color for the dots
    Random rand = new Random();
    float red = rand.nextFloat() * (220f/255f);
    float green = rand.nextFloat() * (220f/255f);
    float blue = rand.nextFloat() * (220f/255f);
